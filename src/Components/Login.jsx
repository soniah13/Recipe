...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Register first to log in");
      console.error(e);
    }
  };
    ...
    <>
      <div className='bg-gradient-to-tr from-blue-200 via-green-300 to-lime-500 h-screen w-full pt-36 flex justify-center align-center '>
        <div className='h-3/4 w-1/2 center bg-yellow-100 rounded-3xl'>
          ...
          <p className='text-center text-xl text-green-700 my-5'>Yay! You're already a member</p><hr />
          ...
          <form onSubmit={handleSubmit}>
            <div className='flex m-5 p-5'>
              ...
              <input className='bg-transparent rounded-md border border-2 border-green-200 w-full p-3'
            ...
            <div className='flex flex-col justify-center p-10 gap-y-5'>
              <button className='font-bold text-2xl text-center bg-green-200 text-black border border-2 border-green-300 rounded-3xl mr-10 p-2
                w-full hover:bg-green-300 active:scale-[.98]
                active:duration-75 hover:scale-[1.02] ease-in-out transition-all active:bg-purple-600' type='submit' onClick={handleSubmit}>Sign In</button>
            </div>
          </form>
        </div>
      </div>
